...
class Income(Base, TimestampedMixin, OwnedByMember):
    ...
    income_id: Mapped[int] = mapped_column(BigIntPK, primary_key=True, autoincrement=True)
...
class IncomeCategory(Base, TimestampedMixin, SoftDeleteMixin, OwnedByMember):
    ...
    income_category_id: Mapped[int] = mapped_column(BigIntPK, primary_key=True, autoincrement=True)
